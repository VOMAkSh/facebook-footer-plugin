<?php
    ...
    class Facebook_Link_Footer_Link_Scripts {

        function __construct () {
            add_action('wp_enqueue_scripts', array($this, 'fb_link_plugin_add_scripts_styles'));
        }
    ...
    new Facebook_Link_Footer_Link_Scripts();
